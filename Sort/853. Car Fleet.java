...
Solution: create cars array by their position and time to target
          sort cars by their position in desending order which means the closer cars first
          for each car, check all the cars that are behind it but have less time, and they count one
O(nlogn),O(n)          
