...
class LogSystem {
    ...
    public List<Integer> retrieve(String s, String e, String gra) {
        int idx = 0;
        switch(gra) {
            case "Year": idx = 4; break;
            case "Month": idx = 7; break;
            case "Day": idx = 10; break;
            case "Hour": idx = 13; break;
            case "Minute": idx = 16; break;
            case "Second": idx = 19; break;
        }
        s = s.substring(0, idx);
        e = e.substring(0, idx);
        List<Integer> ans = new ArrayList<>();
        for (int id : map.keySet()) {
            String cur = map.get(id).substring(0, idx);
