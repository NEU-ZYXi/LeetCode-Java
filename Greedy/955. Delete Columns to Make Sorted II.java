...
Solution: check each index, if not sorted, delete this index and check next one
          if all strings are sorted in this index, mark them as sorted if the characters are not equal
O(nm),O(n)          
